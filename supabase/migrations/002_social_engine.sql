-- ==============================================================================
-- Migration 002: SOCIAL ENGINE TABLES
-- Copied from social_engine_schema.sql — tracked in version control
-- ==============================================================================
...
-- 4. Activities Table (Social Feed / Nexus)
...
CREATE POLICY "Challenges viewable by involved parties" ON public.challenges FOR SELECT USING (true);
...
CREATE POLICY "Users can manage their follows" ON public.follows FOR INSERT WITH CHECK (true);
