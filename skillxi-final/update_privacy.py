  ...
  <div style="max-width:1000px; margin:0 auto;">
    ...
    <div style="text-align:center; margin-bottom:48px;">
      ...
      <p style="color:#a0a0b8; font-size:18px; line-height:1.6; max-width:700px; margin:0 auto;">
        SkillXI beta uses encrypted lineup storage, delayed reveal, and wallet-signed Solana Devnet entries.
      </p>
    </div>
    ...
    <div style="background:rgba(0,255,136,0.05); border:1px solid rgba(0,255,136,0.3); border-radius:16px; padding:24px; text-align:center;">
      ...
      <p style="color:#a0a0b8; font-size:14px; line-height:1.6; margin:0;">
        SkillXI documents precise beta guarantees: encrypted remote lineup storage, hidden picks until reveal, wallet signatures, and compliance gates for paid beta. This is not a deployed stealth-payment protocol.
      </p>
    </div>
